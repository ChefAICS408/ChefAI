...
def computerGenerated(toinclude):
    ...
    verb_file = open("./static/assets/verbs.txt", "r")
    ...
    first_verb = pandas.read_csv("./static/assets/first_verb_probs.csv", header=None)
    ...
    next_ingr = pandas.read_csv("./static/assets/step_ingredient_probs.csv", header=None)
    ...
    next_verb = pandas.read_csv("./static/assets/next_verb_probs.csv", header=None)
    ...
    while len(final_ingredietns) > 0:
        ...
        step += " " + headers[max_ingr_idx]
        directions.append(step)
        step = ""
        print()

        ingredients.append(headers[max_ingr_idx])
    ...
    obj["title"] = "Our chef says Bon Appétit!"
